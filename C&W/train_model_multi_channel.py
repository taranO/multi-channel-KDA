...
########################################################################################################################
parser = argparse.ArgumentParser(description="Train multi-channel system with Key based Diversified Aggregation.")

parser.add_argument("--type",    default="mnist", help="The dataset.")
parser.add_argument("--save_to", default="checkpoints", help="Path where to save models.")
...
if __name__ == "__main__":
    ...
    save_to_ = makeDir(args.save_to + "/" + args.type)
